  ...
  return (
    <>
      <div className="flex flex-col">
        <div className="flex sm:flex-row flex-col items-center text-center sm:text-start sm:items-stretch bg-gradient-to-tr from-slate-950 via-cyan-800 to-teal-500 xl:mb-0 sm:mb-[-1.5rem] p-5 xl:p-10 py-16 ">
          <img
