...
const Contact = () => {
  ...
  return (
    <div className="text-center bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-900 via-slate-600 to-gray-900">
      <Link to="/rlist">
      ...
      <div className="flex justify-center items-center min-h-screen p-8 md:p-16 pt-14 md:mt-0 overflow-clip">
            ...
            <div className="md:w-2/3">
              <div className="p-6 text-center md:text-left -mt-9 sm:mt-auto">
                ...
                <p className="text-justify">
                  Hello there! I'm {name}, a passionate web developer with a
                  keen eye for detail and a love for crafting clean,
                  user-friendly web experiences. My journey is guided by
                  continuous learning and a dedication to delivering
